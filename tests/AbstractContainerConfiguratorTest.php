...
class AbstractContainerConfiguratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @return \Pinepain\League\Container\Extras\AbstractContainerConfigurator | \PHPUnit_Framework_MockObject_MockObject
     */
    public function getConfiguratorMock()
    {
        return $this->getMockBuilder('\Pinepain\League\Container\Extras\AbstractContainerConfigurator')
